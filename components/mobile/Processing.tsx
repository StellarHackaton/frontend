...
// Calm "money converging" animation for the ~5s settle. Six dots fly inward to a
// wobbling core, framing the cross-asset conversion as intentional, not an error.
const CONV = [
  { x: 54, y: 0, delay: 0 },
    ...
    <div className="flex flex-1 flex-col items-center justify-center p-8">
      <div className="relative mb-11 flex h-[180px] w-[180px] items-center justify-center">
        <div
          ...
          style={{
            background:
              "radial-gradient(closest-side,rgba(47,42,107,.20),rgba(47,42,107,0))",
