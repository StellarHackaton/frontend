      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-[110px]">
          ...
          <button
            ...
            className="liquid-glass mt-1 flex w-full items-center gap-3 rounded-[20px] p-4 text-left active:scale-[.98]"
          >
            <span className="flex h-10 w-10 flex-none items-center justify-center rounded-full bg-primary/[.12] text-primary">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
                <path d="M4 20V10M10 20V4M16 20v-7M22 20H2" />
              </svg>
            </span>
            <span className="min-w-0 flex-1">
              <span className="block font-display text-[15px] font-bold">Insights</span>
              <span className="block text-[12.5px] text-muted">Revenue chart & activity</span>
            </span>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-none text-faint">
              <path d="m9 6 6 6-6 6" />
            </svg>
          </button>
