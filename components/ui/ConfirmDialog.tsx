      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 z-50 w-[calc(100%-40px)] max-w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-[24px] bg-paper p-6 text-center shadow-[0_24px_60px_rgba(0,0,0,.22)]"
          >
